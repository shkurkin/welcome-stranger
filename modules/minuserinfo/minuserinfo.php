...
class MinUserInfo extends Module
{
	public function __construct()
	{
		$this->name = 'minuserinfo';
		...
		$this->displayName = $this->l('Mini-User info block');
		$this->description = $this->l('Adds a mini-block that displays information about the customer.');
	}
	...
	*/
	...
	{
		$this->context->controller->addCSS(($this->_path).'minuserinfo.css', 'all');
        $this->context->controller->addJS($this->_path.'js/minuserinfo.js');
	}
		...
		return $this->display(__FILE__, 'minuserinfo.tpl');
        }
}
