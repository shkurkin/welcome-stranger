                            ...
                            {if $use_taxes}
                                {if $priceDisplay}
                                    <tr class="cart_total_price">
                                        ...
                                        <td/>
                                        <td/>
                                        <td>{if $display_tax_label}{l s='Total products (tax excl.)'}{else}{l s='Sub-total'}{/if}</td>
                                ...
                                {else}
                                    <tr class="cart_total_price">
                                        ...
                                        <td/>
                                        <td/>
                                        <td>{if $display_tax_label}{l s='Total products (tax incl.)'}{else}{l s='Sub-total'}{/if}</td>
...
{if $use_taxes}
    ...
    <tr class="cart_total_price">
        ...
        <td class="total_price_container" id="total_price_container">{l s='Total'}</td>
        <td class="price total_price_container" id="total_price">{displayPrice price=$total_price}</td>
    </tr>
{else}
    <tr class="cart_total_price">
                                ...
                                <p class="submit"><input type="hidden" name="submitDiscount" /><input type="submit" name="submitAddDiscount" value="{l s='ok'}" class="button" /></p>
                                    ...
                                    <div id="display_cart_vouchers">
                                        {foreach from=$displayVouchers item=voucher}
                                            <span onclick="$('#discount_name').val('{$voucher.name}');
                                                    return false;" class="voucher_name">{$voucher.name}</span> - {$voucher.description} <br />
                                        {/foreach}
                                    </div>
                                {/if}
                            </fieldset>
        ...
        <td class="price total_price_container" id="total_price_container">{l s='Total'}</td>
        <td class="price total_price_container" id="total_price">{displayPrice price=$total_price_without_tax}</td>
    </tr>
{/if}
</tfoot>
<tbody>
